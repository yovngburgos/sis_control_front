...
@Composable
fun AdminInstallationsScreen(
    paddingValues: PaddingValues,
    navController: NavController,
    token: String,
    role: String,
    onCreateInstallation: () -> Unit = {}
) {
    ...
    Column(
        ...
        Box(
            ...
            Column {
                ...
                OutlinedTextField(
                    ...
                    placeholder = { Text("Buscar instalación...", color = Color.White.copy(alpha = 0.6f)) },
        ...
        Row(
            ...
            Button(
                ...
                Text("Instalaciones", color = Color.White, fontSize = 13.sp, fontWeight = FontWeight.Bold)
            }
            Button(
        ...
        LazyColumn(
            ...
            item {
                Row(
                    ...
                    Text("Instalaciones (2)", fontSize = 18.sp, fontWeight = FontWeight.Bold, color = TextPrimary)
                    Button(
                ...
                // Hardcoded Installations
                InstallationCard(
                    name = "Bodega Central Norte",
                    address = "Av. Siempre Viva 123, Sector Norte",
                    status = "ACTIVA",
                    guardCount = 4
                )
                Spacer(modifier = Modifier.height(12.dp))
                InstallationCard(
                    ...
                    address = "Calle Los Robles 456, Sector Sur",
                    status = "ACTIVA",
                    guardCount = 2
                )
            }
    ...
    SISCard(modifier = Modifier.fillMaxWidth()) {
        Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.Top) {
            ...
            Box(
                ...
                Icon(Icons.Default.Business, contentDescription = null, tint = TextSecondary, modifier = Modifier.size(30.dp))
            }
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("Guardias asignados: ", fontSize = 12.sp, color = TextSecondary, fontWeight = FontWeight.Medium)
                    Text("$guardCount", fontSize = 12.sp, color = PrimaryColor, fontWeight = FontWeight.Bold)
                }
            }
        }
    }
